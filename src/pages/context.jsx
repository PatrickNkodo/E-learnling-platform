...
const Context = ({ children }) => {
  // Define a component that provides the context to its children
  ...
  async function createUser(fields) {
    let data = await customFetch("/signin", {
      method: "post",
      body: { ...fields },
    });
    return data;
  ...
  async function updateProfile(fields) {
    let data = await customFetch("/update", {
      method: "PATCH",
      body: { ...fields },
    });
    return data;
  ...
  async function createCourse(fields) {
    let data = await customFetch("/addcourse", {
      method: "post",
      body: { ...fields },
    });
    return data;
  ...
  async function addLesson(fields) {
    let data = await customFetch("/addlesson", {
      method: "post",
      body: { ...fields },
    });
    return data;
  ...
  async function enrollTocourse(fields) {
    let data = await customFetch("/enroll", {
      method: "post",
      body: { ...fields },
    });
    return data;
  ...
  async function fetchActualLesson(id, lesson) {
    let data = await customFetch(`/actuallesson?id=${id}&num=${lesson}`, {
      method: "get",
    });
    return data;
  }
  async function fetchNextLesson(id, num) {
    let data = await customFetch(`/nextlesson?id=${id}&num=${num}`, {
      method: "get",
    });
    return data;
  }
  async function fetchPrevLesson(id, num) {
    let data = await customFetch(`/prevlesson?id=${id}&num=${num}`, {
      method: "get",
    });
    return data;
  }
  async function saveProgression(id, num, index) {
    let data = await customFetch(
      `/saveprogression?id=${id}&num=${num}&index=${index}`,
      { method: "PATCH" }
    );
    return data;
  }
  async function deleteLesson(fields) {
    let data = await customFetch("/deletelesson", {
      method: "delete",
      body: { ...fields },
    });
    return data;
