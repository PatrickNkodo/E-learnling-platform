  ...
  useEffect(() => {
    const handleScroll = () => {
      if (componentRef.current != null) {
        ...
        //getBoundingCLientRect returns 3 values: top(distance from top value of viewport to top value of component),bottom(distance from top of viewport to bottom of component),height(height of component. ie bottom-top)
        ...
        <Row>
          <Col lg="6" md="6">
            <div className="about__img">
              <img src={aboutImg} alt="" className="w-90" />
            </div>
          </Col>
